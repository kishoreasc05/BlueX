  ...
  const steps = [
    {
      ...
      border: "border-zinc-200 hover:border-[#2563eb] shadow-sm bg-white",
    },
    {
      icon: UserCheck,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12 mb-28">
          ...
          <div className="w-full lg:w-[45%] flex flex-col items-start text-left">
            ...
            >
              ...
              <span className="text-[#2563eb]">{t("trustProfile.titleItalic")}</span>
            </motion.h2>
            ...
            >
              ...
              <div className="flex-1 bg-white border border-zinc-200 rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-all duration-300 cursor-pointer">
                <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center shrink-0 border border-blue-100 text-[#2563eb]">
                ...
                <div>
                  ...
                  <p className="text-zinc-550 text-xs mt-0.5">{t("trustProfile.card1Desc")}</p>
                </div>
              </div>
              {/* Card 2 */}
              <div className="flex-1 bg-white border border-zinc-200 rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-all duration-300 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-zinc-550 text-xs mt-0.5">{t("trustProfile.card2Desc")}</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="w-full lg:w-[55%] flex flex-col items-center justify-center mt-10 lg:mt-0">
            ...
            <motion.div
              ...
              className="w-full max-w-[380px] bg-white border border-zinc-200 rounded-3xl p-6 shadow-xl relative z-20 flex flex-col hover:border-[#2563eb] transition-all duration-300"
            >
              {/* Header: Photo & Title */}
              <div className="flex items-center gap-4 mb-5 text-left">
                <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-blue-600 to-[#2563eb] flex items-center justify-center text-white text-lg font-bold shrink-0 shadow-sm">
                  MK
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h3 className="text-lg font-bold text-zinc-900 tracking-tight">Marc Keller</h3>
                    <span className="text-[10px] font-bold text-[#2563eb] bg-blue-50 px-2 py-0.5 rounded-full border border-blue-200 flex items-center gap-0.5">
                      <ShieldCheck className="w-3 h-3 text-[#2563eb] fill-blue-50" />
              ...
              <div className="flex flex-col gap-3.5 mb-6 text-left">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-blue-50 border border-blue-200 flex items-center justify-center shrink-0 mt-0.5 text-[#2563eb]">
              ...
              {/* Book Button CTA */}
              <button className="w-full h-12 rounded-xl bg-[#2563eb] text-white font-bold text-sm hover:bg-[#1d4ed8] transition-all duration-300 flex items-center justify-center gap-2 group shadow-sm cursor-pointer">
            ...
            <div className="w-full max-w-[380px] mt-6 flex flex-col gap-4">
              ...
              <motion.div
                ...
                className="bg-[#2563eb] text-white rounded-2xl px-4 py-3 shadow-md flex items-center gap-3 border border-blue-500"
              >
        ...
        <div className="w-full text-center relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-zinc-900 leading-tight mb-6">
              {t("howItWorks.title")}{" "}
              <span className="text-[#2563eb] block mt-1 font-bold">
