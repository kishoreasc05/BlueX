  ...
  return (
    <section className="w-full relative bg-white text-slate-900 overflow-hidden py-32 md:py-48 z-20 font-sans border-t border-slate-100">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-end justify-center">
        ...
        <div 
          className="relative w-[1200px] h-[500px] rounded-t-[2.5rem] border-t border-slate-200/60 border-x opacity-60 z-0 bg-white/50 shadow-2xl shadow-indigo-900/5 backdrop-blur-3xl overflow-hidden translate-y-32"
        >
      ...
      <div className="relative z-20 max-w-[800px] mx-auto text-center px-6">
        ...
        >
          Ready to run your business <span className="italic font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">intelligently?</span>
        </motion.h2>
        ...
        >
          Join thousands of modern enterprises building their automated, AI-native workflows on BlueX OS today.
        </motion.p>
        ...
        >
          ...
          >
            Get started for free <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
          </a>
          <a 
            href="/pricing" 
