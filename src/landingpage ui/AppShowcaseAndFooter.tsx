  ...
  const testimonials = [
    {
      ...
      quote:
        t("landingNew.testimonials.quote1") ||
        "Found a plumber within minutes. He was professional, on time and fixed the issue perfectly. Highly recommended!",
      avatar:
    ...
    },
    {
      ...
      quote:
        t("landingNew.testimonials.quote2") ||
        "The platform is super easy to use. I booked a cleaner for my apartment and she did an amazing job!",
      avatar:
    ...
    },
    {
      ...
      quote:
        t("landingNew.testimonials.quote3") ||
        "Great experience! The electrician was very knowledgeable and finished the work quickly. Will use again.",
      avatar:
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-black text-zinc-900 leading-none">{stat.num}</span>
        ...
        <div className="w-full bg-[#030712] border border-white/5 rounded-3xl p-8 md:p-12 text-left mb-24 flex flex-col lg:flex-row gap-12 items-center shadow-2xl relative overflow-hidden text-white">
          ...
          <div className="flex flex-col flex-grow">
            ...
            <p className="text-zinc-400 text-xs font-semibold leading-relaxed mb-6 max-w-[450px]">
              {t("landingNew.app.desc") ||
                "Book services, chat with professionals, track your jobs and make secure payments - all from your phone."}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3.5 mb-8">
              ...
              >
                ...
                <div className="flex flex-col items-start leading-none text-left">
                  <span className="text-[8px] text-zinc-400 font-bold uppercase">
                    {t("landingNew.app.applePre") || "Download on the"}
                  </span>
                  <span className="text-xs font-black mt-0.5">
                    {t("landingNew.app.appleTitle") || "App Store"}
                  </span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col items-start leading-none text-left">
                  <span className="text-[8px] text-zinc-400 font-bold uppercase">
                    {t("landingNew.app.googlePre") || "GET IT ON"}
                  </span>
                  <span className="text-xs font-black mt-0.5">
                    {t("landingNew.app.googleTitle") || "Google Play"}
                  </span>
                </div>
              </a>
            </div>
        ...
        >
          ...
          <div className="flex flex-col items-center lg:items-end gap-3 relative z-10 w-full lg:w-auto shrink-0">
            <form
              ...
              className="flex bg-white rounded-xl overflow-hidden p-1 shadow-inner h-12 w-full max-w-[400px]"
            >
              <input
                type="email"
