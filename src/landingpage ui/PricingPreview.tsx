...
const plans = [
  ...
  },
  {
    ...
    price: "$199",
    period: "/mo",
    features: ["Up to 20 users", "Advanced logic & approvals", "Unlimited AI Copilot", "Priority 24/7 support", "Custom reporting"],
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    features: ["Unlimited users", "Custom AI training", "Dedicated success manager", "SOC2 compliance reporting"],
...
export default function PricingPreview() {
  return (
    <section className="w-full py-32 md:py-48 px-6 bg-[#030303] relative z-20 font-sans border-t border-white/5" id="pricing">
        ...
        <div className="text-center mb-24 relative">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 shadow-[0_0_20px_rgba(79,70,229,0.1)]">
              ...
              <span className="text-xs font-semibold tracking-widest uppercase text-zinc-300">Pricing Plans</span>
            </div>
            <h2 className="font-display text-5xl md:text-7xl tracking-tight text-white leading-[1.1] mb-6 font-light">
              Simple, transparent <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 italic">pricing.</span>
            </h2>
            <p className="text-zinc-400 text-lg md:text-xl max-w-[600px] mx-auto leading-relaxed">
              Start small or scale globally. We have a plan designed to fit the exact needs of your organization.
            </p>
          </motion.div>
        </div>
          ...
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="relative z-10 mb-10 flex items-baseline gap-1">
                <span className="text-6xl font-display font-medium tracking-tight text-white">{plan.price}</span>
              ...
              <ul className="relative z-10 flex flex-col gap-5 mb-10 flex-1">
                {plan.features.map((feature, fIdx) => (
                  <li key={fIdx} className="flex items-start gap-3 text-sm text-zinc-300">
                    <div className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${plan.primary ? 'bg-indigo-500/20 text-indigo-400' : 'bg-white/10 text-white'}`}>
