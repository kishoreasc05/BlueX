...
export default function AICopilotSection() {
  return (
    <section id="ai" className="w-full py-24 md:py-32 px-6 bg-slate-50 relative z-20 overflow-hidden">
      
      {/* Background Image Layer */}
      <div className="absolute inset-0 z-0">
        <img src={aiBg} alt="Background" className="w-full h-full object-cover object-center opacity-100" />
        ...
        <div className="w-full lg:w-1/2 relative h-[600px] flex items-center justify-center">
          ...
          <div className="relative w-full max-w-[420px] h-[540px] bg-white/60 backdrop-blur-2xl border border-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] rounded-[2.5rem] p-6 overflow-hidden flex flex-col">
            ...
            <div className="flex items-center justify-between w-full pb-4 border-b border-slate-200/60 mb-6">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-900 leading-tight">BlueX Copilot</span>
            ...
            <div className="flex flex-col gap-6 w-full relative z-10">
              ...
              >
                <p className="text-[14px] text-slate-700 leading-relaxed">Can you summarize the Acme Corp MSA and highlight any unusual liability clauses?</p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] uppercase tracking-wider font-semibold text-zinc-400">BlueX AI</span>
                </div>
                <p className="text-[14px] text-zinc-200 leading-relaxed">I've reviewed the 42-page MSA. The liability cap is set at <span className="font-semibold text-white bg-white/10 px-1 rounded">3x fees</span>, which deviates from your standard 1x. I've drafted a revision for the legal team.</p>
              ...
              <motion.div 
                ...
                className="self-end bg-white border border-slate-100 shadow-sm rounded-2xl rounded-tr-sm p-4 max-w-[85%]"
              >
                <p className="text-[14px] text-slate-700 leading-relaxed">Perfect. Route it to Sarah for approval and draft an email to the client.</p>
              </motion.div>
            </div>
            ...
            >
              ...
              <span className="text-[14px] font-semibold text-slate-800">Automated workflow executed</span>
            </motion.div>
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl tracking-tight text-slate-900 leading-[1.1] mb-6 drop-shadow-sm">
              Your intelligent agent for <span className="italic text-accent relative inline-block">
                deep work.
