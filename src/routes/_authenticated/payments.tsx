    ...
    <div className="space-y-6 pb-12 max-w-[1400px] mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            {[
              { id: "INV-2026-001", client: "Acme Corp", amount: "$4,500", status: "Paid", date: "Jul 01, 2026" },
              { id: "INV-2026-002", client: "Globex Inc", amount: "$1,200", status: "Pending", date: "Jul 05, 2026" },
              { id: "INV-2026-003", client: "Initech", amount: "$8,000", status: "Overdue", date: "Jun 15, 2026" },
            ].map((payment, i) => (
