      ...
      <div className="flex-1 bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col overflow-hidden">
        <div className="flex-1 p-6 overflow-y-auto space-y-6">
          <div className="flex gap-4">
            ...
            <div className="bg-slate-50 border border-slate-100 p-4 rounded-2xl rounded-tl-none text-sm text-slate-700 max-w-[80%]">
              Hello! I'm your BlueX AI Copilot. I can help you analyze reports, draft contracts, or
              summarize your recent activity. How can I assist you today?
            </div>
          </div>
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50/50">
          <div className="relative flex items-center">
            ...
            <Button
              size="icon"
              className="absolute right-2 h-8 w-8 bg-indigo-600 hover:bg-indigo-700 rounded-lg"
            >
