          ...
          <div>
            ...
            <FadeIn delay={0.1} direction="up">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-8">
                Unify your projects, workflows, contracts, and payments into one intelligent, secure workspace.
              </p>
            </FadeIn>
            ...
            <div className="mt-8 text-center text-sm text-zinc-400">
              {mode === "signup" ? (
                <>
                  ...
                  <button className="text-white hover:text-indigo-400 font-medium transition-colors" onClick={() => setMode("signin")}>
                    Sign in here
                  </button>
                </>
              ) : (
                <>
                  ...
                  <button className="text-white hover:text-indigo-400 font-medium transition-colors" onClick={() => setMode("signup")}>
                    Create one now
                  </button>
                </>
              )}
